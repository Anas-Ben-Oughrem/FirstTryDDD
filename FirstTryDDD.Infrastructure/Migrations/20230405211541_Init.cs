    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReaderBookList", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReaderBookList_Book_BookId",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReaderBookList_Reader_ReaderId",
                        column: x => x.ReaderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReaderBookList_BookId",
                table: "ReaderBookList",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_ReaderBookList_ReaderId",
                table: "ReaderBookList",
                column: "ReaderId");
        }
